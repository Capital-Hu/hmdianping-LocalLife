...
echo.
echo Starting Broker connecting to NameServer at localhost:9876...
java -cp rocketmq-all-5.3.2-bin-release\lib\* org.apache.rocketmq.broker.BrokerStartup -n localhost:9876
